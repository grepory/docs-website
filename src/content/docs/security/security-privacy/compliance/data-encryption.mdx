...
New Relic ensures the security of your data at rest with (FIPS 140-2 compliant) cryptography. For more information, see more documentation about our [Telemetry Data Platform](/docs/telemetry-data-platform/ingest-manage-data/get-started/get-know-telemetry-data-platform) and [managing data retention](/docs/telemetry-data-platform/ingest-manage-data/manage-data/manage-data-retention).
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Encryption at rest depends on your New Relic subscription and your [account hierarchy](/docs/accounts/install-new-relic/account-setup/manage-apps-or-users-sub-accounts). For example, if your data is encrypted at the master account level, your sub-account data also is automatically encrypted at rest.
